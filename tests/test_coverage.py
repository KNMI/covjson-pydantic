...
happy_cases = [
    ...
    ("spec-domain-polygon.json", Domain),
    ("spec-domain-polygon-no-t.json", Domain),
...
error_cases = [
    ...
    (
        "polygon-domain-too-many-t.json",
        Domain,
        r"If provided, the 'values' field of the ValuesAxis 't'-axis "
        + "of a 'Polygon' domain must contain a single value.",
    ),
    ("polygon-domain-no-composite.json", Domain, r"A 'Polygon' must have a 'composite'-axis."),
